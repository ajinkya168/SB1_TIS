        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-24-14, 62, Math.toRadians(-90)))
                                .splineToLinearHeading(new Pose2d(-24-14, 36, Math.toRadians(-180)),Math.toRadians(-90))
                                .lineToLinearHeading(new Pose2d(-24-10, 36, Math.toRadians(-180)))
                                .lineToLinearHeading(new Pose2d(-24-10, 20, Math.toRadians(-180)))
...
//                                .splineToLinearHeading(new Pose2d(-24-24-8, 10, Math.toRadians(-180)), Math.toRadians(-90))
//                                .lineToLinearHeading(new Pose2d(48, 12, Math.toRadians(-180)))
//                                .lineToLinearHeading(new Pose2d(48.25, 35, Math.toRadians(-180)))
