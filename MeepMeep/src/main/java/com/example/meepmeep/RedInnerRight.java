...
//
                                .lineToLinearHeading(new Pose2d(13, -48, Math.toRadians(0)))
                                .splineToLinearHeading(new Pose2d(48, -44, Math.toRadians(180)), Math.toRadians(0))
