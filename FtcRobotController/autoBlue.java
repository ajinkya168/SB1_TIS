...
//                .waitSeconds(5)
                ...
                .splineToLinearHeading(new Pose2d(48, 35, Math.toRadians(-180)),Math.toRadians(-90))
                .addTemporalMarker(()->{ output_power = lifter_pid(kp, ki, kd, 60);
                    if (output_power > 0.9) {
                        output_power = 1;
...
//                .waitSeconds(5)
                ...
                .waitSeconds(0.5)
                .lineToLinearHeading(new Pose2d(10,37, Math.toRadians(0)))
                .lineToLinearHeading(new Pose2d(10,40, Math.toRadians(45)))
                .splineToLinearHeading(new Pose2d(48, 42, Math.toRadians(-180)), Math.toRadians(-180))
                .addTemporalMarker(()->{
                ...
                .addTemporalMarker(()->Outtake.stopper.setPosition(0.3))
                .waitSeconds(0.3)
                .addTemporalMarker(()->Intake.SetIntakePosition(0.68))
                .waitSeconds(0.2)
                .addTemporalMarker(()->{ output_power = lifter_pid(kp, ki, kd, 0);
                    if (output_power > 0.9) {
                        output_power = 1;
...
//                .splineToLinearHeading(new Pose2d(20, 32, Math.toRadians(-90)),Math.toRadians(-90))
                ...
                .splineToLinearHeading(new Pose2d(48, 28, Math.toRadians(-180)),Math.toRadians(-90))
                .addTemporalMarker(()->{
                    output_power = lifter_pid(kp, ki, kd, 60);
                    if (output_power > 0.9) {
                        output_power = 1;
