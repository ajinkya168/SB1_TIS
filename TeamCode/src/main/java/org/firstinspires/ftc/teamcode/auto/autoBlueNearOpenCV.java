...
@Autonomous
public class autoBlueNearOpenCV extends LinearOpMode {
...
//                .waitSeconds(5)
                ...
                .lineToLinearHeading(new Pose2d(50, 62, Math.toRadians(-180)))
...
//                .waitSeconds(5)
                ...
                .lineToLinearHeading(new Pose2d(52, 62, Math.toRadians(-180)))
                .addTemporalMarker(() -> Intake.SetIntakePosition(0.2))
                .build();
