...
//                .waitSeconds(5)
                ...
                .waitSeconds(0.8)
                .lineToLinearHeading(new Pose2d(55.5, -12, Math.toRadians(-180)))
                .UNSTABLE_addTemporalMarkerOffset(-0.1, ()->{
                    Outtake.crab.setPosition(0.68);
                    output_power = lifter_pid(kp, ki, kd, 20);
                    if (output_power > 0.9) {
                        output_power = 1;
                ...
                .lineToLinearHeading(new Pose2d(57, -34, Math.toRadians(-180)))
                ...
                .waitSeconds(1)
                .lineToLinearHeading(new Pose2d(57, -42, Math.toRadians(-180)))
                .addTemporalMarker(()->Outtake.outtakeWrist.setPosition(0.7))
        ...
        TrajectorySequence right= drive.trajectorySequenceBuilder(startPose)
              .splineToLinearHeading(new Pose2d(-24-8, -24, Math.toRadians(0)),Math.toRadians(90))
                ...
                .waitSeconds(0.4)
                .lineToLinearHeading(new Pose2d(-24-14, -30, Math.toRadians(90)))
                ...
                .waitSeconds(0.2)
                .addTemporalMarker(()->Intake.SetIntakePosition(0.6))
                .lineToLinearHeading(new Pose2d(56.2, -42, Math.toRadians(-180)))
                .UNSTABLE_addTemporalMarkerOffset(-0.2,()->Outtake.setOuttakeArm(0.98))
                .addTemporalMarker(()->Outtake.outtakeWrist.setPosition(0.7))
                .waitSeconds(0.8)
                .addTemporalMarker(()->Outtake.crab.setPosition(0.68))
                ...
                .addTemporalMarker(()->Outtake.stopper.setPosition(0.3))
                .waitSeconds(1)
                .lineToLinearHeading(new Pose2d(56.2, -36, Math.toRadians(-180)))
                .addTemporalMarker(()->Outtake.outtakeWrist.setPosition(0.7))
                .addTemporalMarker(()->Outtake.crab.setPosition(0.5))
                .waitSeconds(0.1)
                .addTemporalMarker(()->Outtake.stopper.setPosition(0.3))
                ...
                .addTemporalMarker(()->Outtake.outtakeWrist.setPosition(0))
                .waitSeconds(0.3)
                .lineToLinearHeading(new Pose2d(56.2, -9, Math.toRadians(-180)))
                .lineToLinearHeading(new Pose2d(60, -9, Math.toRadians(-180)))
                .addTemporalMarker(()->Intake.SetIntakePosition(0.2))
                .build();
        ...
        TrajectorySequence left = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToLinearHeading(new Pose2d(-24-8, -10, Math.toRadians(-180)))
                ...
                .addTemporalMarker(()->Intake.IntakeStop())
                .waitSeconds(0.2)
                .lineToLinearHeading(new Pose2d(57.5, -30, Math.toRadians(-180)))
                .UNSTABLE_addTemporalMarkerOffset(-0.2,()->Outtake.setOuttakeArm(0.98))
                .addTemporalMarker(()->Outtake.outtakeWrist.setPosition(0.7))
                .waitSeconds(0.8)
                .addTemporalMarker(()->Outtake.crab.setPosition(0.68))
