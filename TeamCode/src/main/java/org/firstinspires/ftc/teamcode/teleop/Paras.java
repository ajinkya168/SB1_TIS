...
import org.firstinspires.ftc.teamcode.geometry.MathUtils;
import org.firstinspires.ftc.teamcode.geometry.Pose;
import org.firstinspires.ftc.teamcode.geometry.RobotHardwareK;
import org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequence;

@TeleOp
@Config
public class Paras extends LinearOpMode {
...
//    public static double kp0 = 2.75, ki0, kd0 = 0.4;
    ...
    //DRIVE
    private final RobotHardwareK robot = RobotHardwareK.getInstance();
    public MecanumDrivetrain drivetrain;

    public static double intakeServoInitPos = 0.5;
...
//        }
        ...
        while (opModeInInit()) {
            Intake.SetIntakePosition(intakeServoInitPos);
...
//                    drive.followTrajectorySequenceAsync(outtakePos);
                    ...
                    Outtake.outtakeWrist.setPosition(0.6);
                    Outtake.stopper.setPosition(0.5);
