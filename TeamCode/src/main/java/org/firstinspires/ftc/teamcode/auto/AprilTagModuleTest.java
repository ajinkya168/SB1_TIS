...
@Autonomous
public class AprilTagModuleTest extends LinearOpMode {
    ...
    public TrajectorySequence center;
    public TrajectorySequence right1;
    public TrajectorySequence right2;
    public TrajectorySequence right3;

    public Pose2d startPose = null;
    private TrajectorySequence ResetTrajCenter;
    private TrajectorySequence ResetTrajLeft;
    private TrajectorySequence ResetTrajRight;
...
//                .waitSeconds(5)
         ...
         ResetTrajCenter = drive.trajectorySequenceBuilder(new Pose2d(30, 43.5, Math.toRadians(-180)))
                .lineToLinearHeading(new Pose2d(30+0.001, 43.5+0.001, Math.toRadians(-180) ))
                .build();
         ResetTrajLeft = drive.trajectorySequenceBuilder(new Pose2d(30, 50, Math.toRadians(-180)))
                .lineToLinearHeading(new Pose2d(30+0.001, 50+0.001, Math.toRadians(-180) ))
                .build();
