...
public class autoRedFarCycleOpenCV extends LinearOpMode {
...
//                .waitSeconds(5)
        ...
        TrajectorySequence right= drive.trajectorySequenceBuilder(startPose)
                ...
                .splineToLinearHeading(new Pose2d(-56.5, -10, Math.toRadians(-180)), Math.toRadians(90))
                //stack pick
                .addTemporalMarker(()->Intake.SetIntakePosition(0.47))
                .waitSeconds(0.2)
                .addTemporalMarker(()->Intake.IntakeStart())
                .waitSeconds(1)
                .addTemporalMarker(()->Intake.SetIntakePosition(0.47))
                .lineToLinearHeading(new Pose2d(53.7, -12, Math.toRadians(-180)))
                .UNSTABLE_addTemporalMarkerOffset(-0.1, ()->{
                    Outtake.crab.setPosition(0.68);
                    output_power = lifter_pid(kp, ki, kd, 35);
                    if (output_power > 0.9) {
                ...
                .addTemporalMarker(()->Outtake.stopper.setPosition(0.25))
                .waitSeconds(0.5)
                .lineToLinearHeading(new Pose2d(56,-43, Math.toRadians(-180)))
        ...
        TrajectorySequence left = drive.trajectorySequenceBuilder(startPose)
                ...
                .addTemporalMarker(()->Outtake.crab.setPosition(0.68))
                .waitSeconds(0.1)
                .addTemporalMarker(()->Outtake.stopper.setPosition(0.24))
                .waitSeconds(0.5)
                .lineToLinearHeading(new Pose2d(56, -33, Math.toRadians(-180)))
                .addTemporalMarker(()->Outtake.outtakeWrist.setPosition(0.7))
                .addTemporalMarker(()->Outtake.crab.setPosition(0.5))
                .waitSeconds(0.1)
                .addTemporalMarker(()->Outtake.stopper.setPosition(0.25))
