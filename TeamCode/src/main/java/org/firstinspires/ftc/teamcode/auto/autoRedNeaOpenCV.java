...
@Autonomous
public class autoRedNeaOpenCV extends LinearOpMode {
...
//                .splineToLinearHeading(new Pose2d(20, 32, Math.toRadians(-90)),Math.toRadians(-90))
                .splineToLinearHeading(new Pose2d(8, -26, Math.toRadians(180)),Math.toRadians(90))
//                .waitSeconds(5)
                .addTemporalMarker(()->{
                    dropRight.setPosition(0.9);
                })
...
//                .splineToLinearHeading(new Pose2d(20, 32, Math.toRadians(-90)),Math.toRadians(-90))
                .splineToLinearHeading(new Pose2d(10.5, -35, Math.toRadians(0)),Math.toRadians(90))
                .addTemporalMarker(()->{
                    dropRight.setPosition(0.9);
                })
                .waitSeconds(0.5)
                .lineToLinearHeading(new Pose2d(12, -48, Math.toRadians(0)))
                .splineToLinearHeading(new Pose2d(49, -43, Math.toRadians(180)), Math.toRadians(0))
                .addTemporalMarker(()->{
                    output_power = lifter_pid(kp, ki, kd, 20);
                    if (output_power > 0.9) {
                        output_power = 1;
